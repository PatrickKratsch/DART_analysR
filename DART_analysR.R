DART_analysR <- function(clean, sleep_threshold, cell_length, ld_transition = NULL){
  ...
  # sleep_threshold = velocity of flies must be below this value to be considered sleeping
  # cell_length = length of one sampling window in seconds
  # ld_transition = time point in seconds when light-dark transition occurred
  ...
  # Calculate analogue_to_binary df, where 1 indicates sleep, while 0 indicates movement
