DART_gg_totalDistance <- function(all_movement_fit_tidy){
  
  # all_movement_fit_tidy          = tidy output from DART_tidy()
  # Note that you need to set data$genotype to be a factor if you
  # want to change the layout of the boxplot
