DART_transform_batch <- function(dir_path, sample_name_file, start = 1, end = 0, bin = 5, threshold = 3, dead = 4296, csv = FALSE){
  ...
  # dead              = looks through the last 'dead' data points of the experiment to
  #                     determine whether a fly may have been dead - deafault = 4296 (6 h
  #                     after 5-s binning)
  ...
  # or when wanting to remove some light artefacts during light transitions)
